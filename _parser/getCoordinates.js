...
cityInput = document.getElementById("EG3628"), // need get from tag (always update)
searchButton = document.querySelector("#EG3628 + button"), // need get from tag (always update)
