...
cityInput = document.getElementById("Ko3817"), // need get from tag (always update)
searchButton = document.querySelector("#Ko3817 + button"), // need get from tag (always update)
